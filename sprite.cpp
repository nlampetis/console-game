...
Sprite::Sprite(int wx, int wy, const CHAR_INFO &fillchar) : x(wx), y(wy) {
...
Sprite::~Sprite() { delete[] spriteTable; }

const int &Sprite::height() const { return y; }

const int &Sprite::width() const { return x; }

const CHAR_INFO *Sprite::geSpriteTable() const { return spriteTable; }
